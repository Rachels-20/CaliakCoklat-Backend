package com.pbl.phtanah.service;
...
import com.pbl.phtanah.config.RabbitMQConfig;
import com.pbl.phtanah.dto.DeviceResponse;
import com.pbl.phtanah.dto.PhTanahRequest;
import com.pbl.phtanah.dto.PhTanahResponse;
import com.pbl.phtanah.dto.SensorDataEvent;
import com.pbl.phtanah.dto.SensorStatusEvent;
import com.pbl.phtanah.entity.PhTanah;
import com.pbl.phtanah.repository.PhTanahRepository;

import lombok.RequiredArgsConstructor;

@Service
@RequiredArgsConstructor
public class PhTanahService {

        private final PhTanahRepository repository;
        private final RabbitTemplate rabbitTemplate;
        private final RestTemplate restTemplate;
        private static final String DEVICE_URL = "http://device-service:8092/devices/kode/";

        public PhTanahResponse saveData(PhTanahRequest request) {
                ...
                // Ambil data terakhir
                PhTanah lastData = repository.findTopByDeviceIdOrderByWaktuDesc(device.getId());
                ...
                PhTanah saved = repository.save(data);
                ...
                dataEvent.setSensorType("PH_TANAH");
                ...
                if (statusChanged) {
                        ...
                        statusEvent.setSensorType("PH_TANAH");
                ...
                return PhTanahResponse.builder()
                                .id(saved.getId())
        ...
        public PhTanahResponse getLatest(Long deviceId) {
                PhTanah latest = repository.findTopByDeviceIdOrderByWaktuDesc(deviceId);
        ...
        public List<Double> getWeekly(Long deviceId, String date) {
                ...
                for (LocalDate day = start; !day.isAfter(end); day = day.plusDays(1)) {
                        List<PhTanah> dailyData = repository.findByDeviceIdAndWaktuBetween(
                                        deviceId,
                                        day.atStartOfDay(),
                                        day.atTime(23, 59, 59));

                        OptionalDouble optionalAverage = dailyData.stream()
                                        .mapToDouble(PhTanah::getNilai)
                                        .average();
